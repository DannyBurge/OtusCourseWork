package com.otuscoursework.ui.views.dialog
...
import com.otuscoursework.ui.databinding.ViewDialogBinding

class OtusDialogFragment : DialogFragment() {

    private lateinit var dialogType: DialogType

    private lateinit var dialogBinding: ViewDialogBinding
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        return activity?.let {
            ...
            dialogBinding = ViewDialogBinding.inflate(requireActivity().layoutInflater)
